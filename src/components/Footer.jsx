...
function Footer() {
  ...
  const socialLinks = [
    {
      ...
      icon: (
        <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 512 512" className="h-5 w-5">
    ...
    },
    {
      ...
      icon: (
        <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 496 512" className="h-5 w-5">
  ...
  const quickLinks = [
    ...
    { text: "Education", id: "educationId" },
    { text: "Skills", id: "skillsId" },
    { text: "Certifications", id: "certificateId" },
  ...
  return (
    <footer className="footer footer-center p-10 bg-base-200 text-base-content rounded" role="contentinfo">
      ...
      <aside>
        <p className="text-sm">
          Copyright © {currentYear} Pranav Gawas. All rights reserved.
        </p>
